...
gulp.task('watch', function () {
  ...
  gulp.watch(['./scss/**/*.scss'], ['clean-styles', 'styleguide', 'sass']);
  // gulp.watch(['./less/demos/**/*.html'], ['copy-demos']);

  // watches style guide theme files and runs a whole rebuild after saves
  gulp.watch(['./style-guide-theme/**/*'], ['reload-styleguide', 'clean-styles', 'sass']);
});

gulp.task('build', ['clean-styles', 'force-styleguide', 'sass', 'start-server', 'watch']);
